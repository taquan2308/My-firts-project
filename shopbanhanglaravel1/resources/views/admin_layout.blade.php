        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Danh mục nhãn hiệu</span>
                    </a>
                    <ul class="sub">
                        <li><a href="{{URL::to('/add-brand-product')}}">Thêm danh mục nhãn hiệu</a></li>
                        <li><a href="{{URL::to('/all-brand-product')}}">Liệt kê danh mục nhãn hiệu</a></li>
                    </ul>
                </li>
